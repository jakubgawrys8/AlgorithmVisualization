...
def choose_ending_node(starting_node):

    while True:
        random_node = random.choice(gv.walkableList)
        if(random_node != starting_node and random_node.x > 20 and random_node.y > 20):
            ending_node = random_node
            break
